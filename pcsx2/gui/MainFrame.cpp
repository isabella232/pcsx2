...
void MainEmuFrame::ConnectMenus()
{
	...
	// Lua
	Bind(wxEVT_MENU, &MainEmuFrame::Menu_Lua_NewWindow, this, MenuId_Lua_NewWindow);
	Bind(wxEVT_MENU, &MainEmuFrame::Menu_Lua_CloseAllWindows, this, MenuId_Lua_CloseAllWindows);
}
